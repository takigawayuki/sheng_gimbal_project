...
{
    HAL_TIM_Base_Start_IT(&htim7); // TIM7 1ms �ж� 1kHz�Ŀ���Ƶ��
    HAL_TIM_Base_Start_IT(&htim8); // TIM8 10ms �жϣ��� MPU9250 Ԥ����
}
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == TIM7)
    {
        ...
        //     target_valid = 0; // 100ms û������ �� �ж�ʧ

        // gimbal_sm();

        // gimbal_task_state(); // ÿ 1ms ִ��һ��
        ...
        /* 每 1ms 轮询 USART6 Circular DMA，有新视觉帧就解析，没有则快速跳过 */
        Vision_UART_Poll();
